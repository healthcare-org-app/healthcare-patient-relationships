"""HTTP routes for patient-relationships-service.

Generic CRUD over the `patient_relationships` table. Every mutating endpoint publishes a
...
RESOURCE = "patient_relationships"
CREATED_EVENT = ""
UPDATED_EVENT = ""
