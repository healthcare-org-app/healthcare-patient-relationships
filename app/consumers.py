...
def register(svc) -> None:
    ...
    def _on_patient_created(envelope: dict) -> None:
        ...
        try:
            ...
            log.exception("patient-relationships-service/patient.created handler failed: %s", e)
    ...
    def _on_patient_merged(envelope: dict) -> None:
        ...
        try:
            ...
            log.exception("patient-relationships-service/patient.merged handler failed: %s", e)
